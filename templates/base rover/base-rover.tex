...
\begin{itemize}
    \item \textbf{M2 Semester 1 Grade:} 13.47/20 (Admis).
    ...
    \item \textbf{Thesis:} Numerical and experimental study of the THM behavior of concrete under severe accident conditions using a poro-mechanical approach. % [cite: 161-163]
\end{itemize}
...
\begin{description}[itemsep=0pt]
    \item[Technical:] Finite Element Analysis (FEA), THM Coupling, Probabilistic Sensitivity Analysis.
    \item[Software:] Cast3M, LaTeX, VS Code, MS Office, Linux, Revit Structure, AutoCAD, ETABS, SAP2000.
